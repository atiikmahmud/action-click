        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 px-5 mb-5">
                <ul class="tm-social-links d-flex justify-content-end pl-0 mb-5">
                    ...
                    <li class="mb-2"><a href="https://x.com/AtikMahmudTareq"><i class="fab fa-twitter"></i></a></li>
                    <li class="mb-2"><a href="https://www.instagram.com/atiikmahmud"><i class="fab fa-instagram"></i></a></li>
