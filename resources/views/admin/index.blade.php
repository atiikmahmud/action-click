...
<head>
    ...
    <title>Dashboard - Action Click</title>
                                        ...
                                        <ul class="p-0 m-0">
                                            <li class="d-flex mb-6">
                                                <div class="avatar flex-shrink-0 bg-lightest rounded me-3">
                                                    <img src="admin-assets/img/icons/misc/zipcar.png"
                                                        alt="zipcar" />
                                                </div>
                                                <div
                                            ...
                                            <li class="d-flex mb-6">
                                                <div class="avatar flex-shrink-0 bg-lightest rounded me-3">
                                                    <img src="admin-assets/img/icons/misc/bitbank.png"
                                                        alt="bitbank" />
                                                </div>
                                                <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                            ...
                                            <li class="d-flex">
                                                <div class="avatar flex-shrink-0 bg-lightest rounded me-3">
                                                    <img src="admin-assets/img/icons/misc/aviato.png"
                                                        alt="aviato" />
                                                </div>
                                                <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                ...
                                                <ul class="p-0 m-0">
                                                    <li class="d-flex mb-4 align-items-center pb-2">
                                                        <div class="flex-shrink-0 me-4">
                                                            <img src="admin-assets/img/icons/payments/gumroad.png"
                                                    ...
                                                    <li class="d-flex mb-4 align-items-center pb-2">
                                                        <div class="flex-shrink-0 me-4">
                                                            <img src="admin-assets/img/icons/payments/stripes.png"
                                                    ...
                                                    <li class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-4">
                                                            <img src="admin-assets/img/icons/payments/citi.png"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="withdraw-content pt-2">
                                                <ul class="p-0 m-0">
                                                    <li class="d-flex mb-4 align-items-center pb-2">
                                                        <div class="flex-shrink-0 me-4">
                                                            <img src="admin-assets/img/icons/brands/google.png"
                                                    ...
                                                    <li class="d-flex mb-4 align-items-center pb-2">
                                                        <div class="flex-shrink-0 me-4">
                                                            <img src="admin-assets/img/icons/brands/github.png"
                                                    ...
                                                    <li class="d-flex mb-4 align-items-center pb-2">
                                                        <div class="flex-shrink-0 me-4">
                                                            <img src="admin-assets/img/icons/brands/slack.png"
                                                    ...
                                                    <li class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 me-4">
                                                            <img src="admin-assets/img/icons/brands/aws.png"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar avatar-sm me-4">
                                                                <img src="admin-assets/img/avatars/3.png"
                                                                    alt="Avatar" class="rounded-circle" />
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar avatar-sm me-4">
                                                                <img src="admin-assets/img/avatars/2.png"
                                                                    alt="Avatar" class="rounded-circle" />
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar avatar-sm me-4">
                                                                <img src="admin-assets/img/avatars/5.png"
                                                                    alt="Avatar" class="rounded-circle" />
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar avatar-sm me-4">
                                                                <img src="admin-assets/img/avatars/4.png"
                                                                    alt="Avatar" class="rounded-circle" />
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar avatar-sm me-4">
                                                                <img src="admin-assets/img/avatars/7.png"
                                                                    alt="Avatar" class="rounded-circle" />
                                                            </div>
                                                            <div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar avatar-sm me-4">
                                                                <img src="admin-assets/img/avatars/6.png"
                                                                    alt="Avatar" class="rounded-circle" />
                                                            </div>
                                                            <div>
