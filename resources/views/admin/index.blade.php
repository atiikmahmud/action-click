        ...
        <div class="row gy-6">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="row gy-6">
                    ...
                    <!-- End Total Profit Weekly Project -->
                    <!-- New Yearly Project -->
                    <div class="col-sm-6">
                        <div class="card h-100">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                ...
                                <ul class="p-0 m-0">
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-4">
                                            <img src="{{ asset('admin-assets/img/icons/payments/gumroad.png') }}"
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-4">
                                            <img src="{{ asset('admin-assets/img/icons/payments/stripes.png') }}"
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-4">
                                            <img src="{{ asset('admin-assets/img/icons/payments/citi.png') }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="withdraw-content pt-2">
                                <ul class="p-0 m-0">
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-4">
                                            <img src="{{ asset('admin-assets/img/icons/brands/google.png') }}"
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-4">
                                            <img src="{{ asset('admin-assets/img/icons/brands/github.png') }}"
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-4">
                                            <img src="{{ asset('admin-assets/img/icons/brands/slack.png') }}"
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-4">
                                            <img src="{{ asset('admin-assets/img/icons/brands/aws.png') }}"
