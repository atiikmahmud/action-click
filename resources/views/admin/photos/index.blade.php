                            ...
                            @foreach ($photos as $index => $photo)
                                <tr>
                                    ...
                                    <td><img src="{{ $photo->image ? asset('admin-assets/img/photos/' . $photo->image) : asset('admin-assets/img/avatars/1.png') }}"
                                            alt="{{ $photo->name }}" class="w-px-50 h-auto"
                                    ...
                                    <td>
                                        @if ($photo->featured == 1)
                                            <span class="badge rounded-pill bg-label-success me-1"><i class="ri-star-fill"></i></span>
                                        @else
                                            <span class="badge rounded-pill bg-label-danger me-1"><i class="ri-star-line"></i></span>
                                        @endif
                                    </td>
